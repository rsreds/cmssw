#ifndef DataFormats_CaloRecHit_CaloClusterFloat_h
#define DataFormats_CaloRecHit_CaloClusterFloat_h

/** \class reco::CaloClusterFloat 
 *  
...
namespace reco {
  ...
  std::ostream& operator<<(std::ostream& out, const CaloClusterFloat& cluster);
  ...
  public:
    ...
    CaloClusterFloat(AlgoID algoID)
        : energy_(0), correctedEnergy_(-1.0), correctedEnergyUncertainty_(-1.0), algoID_(algoID), flags_(0) {}

    CaloClusterFloat(double energy, const math::XYZPoint& position, const CaloID& caloID)
    ...
    /// resets the CaloClusterFloat (position, energy, hitsAndFractions)
    void reset();

    /// constructor from values
    CaloClusterFloat(double energy, const math::XYZPoint& position)
        : energy_(static_cast<float>(energy)),
          correctedEnergy_(-1.0),
          correctedEnergyUncertainty_(-1.0),
          position_(position),
    ...
    CaloClusterFloat(double energy,
    ...
    void setPosition(const math::XYZPoint& p) { position_ = static_cast<math::XYZPointF>(p); }
    ...
    const math::XYZPointF& position() const { return position_; }

    /// comparison >= operator
    bool operator>=(const CaloClusterFloat& rhs) const { return (energy_ >= rhs.energy_); }
    ...
    double x() const { return static_cast<double>(position_.x()); }

    /// y coordinate of cluster centroid
    double y() const { return static_cast<double>(position_.y()); }

    /// z coordinate of cluster centroid
    double z() const { return static_cast<double>(position_.z()); }

    /// pseudorapidity of cluster centroid
    double eta() const { return static_cast<double>(position_.eta()); }

    /// azimuthal angle of cluster centroid
    double phi() const { return static_cast<double>(position_.phi()); }
    ...
    /// print me
    friend std::ostream& operator<<(std::ostream& out, const CaloClusterFloat& cluster);
  ...
  typedef std::vector<CaloClusterFloat> CaloClusterFloatCollection;
