...
namespace ticl {
  ...
  public:
    ...
    ticl::RecoToSimCollection associateRecoToSim(const edm::Handle<reco::CaloClusterFloatCollection> &cCCH,
    ...
    ticl::SimToRecoCollection associateSimToReco(const edm::Handle<reco::CaloClusterFloatCollection> &cCCH,
                                                 const edm::Handle<CaloParticleCollection> &cPCH) const {
